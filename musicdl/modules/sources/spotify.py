...
class SpotifyMusicClient(BaseMusicClient):
    ...
    def _parsewithmusicfabapi(self, search_result: dict, request_overrides: dict = None):
        ...
        # parse
        (resp := requests.post('https://musicfab.io/api/spotify', json={"url": f"https://open.spotify.com/track/{song_id}"}, headers=headers, timeout=10)).raise_for_status()
    ...
    def _parsewiththirdpartapis(self, search_result: dict, request_overrides: dict = None):
        ...
        for parser_func in [self._parsewithspowloadapi, self._parsewithspotmateapi, self._parsewithspotubedlapi, self._parsewithmusicfabapi, ]:
